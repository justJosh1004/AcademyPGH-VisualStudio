    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            while (play == true)
            {
                ...
                Random direction_num = new Random(); //generate number to determine orientation of ships
                bool ship_check = false; //checks to make sure ships aren't in the same place
                bool good_postion = false;

                int[,] cruiser = new int[3, 3];

                int[] ship1 = new int[2];
                //int[] ship1 = { ship.Next(1, 8), ship.Next(1, 8) }; //generate a number between 1 and 8 

                //try and figure out diretion first, then set parameters if its possible
                while (good_postion == false)
                {
                    
                    ship1[0] = ship.Next(1, 9);
                    ship1[1] = ship.Next(1, 9);
                    int direction = direction_num.Next(4);
                    direction = 0;
                    Console.WriteLine(ship1[0] + " " + ship1[1]);
                    ...
                    if (direction == 0)
                    {
                        if (ship1[1] > 2) //up
                        {
                            cruiser = [ship1[1] - 1, ship1[0] - 1];
                            cruiser = [ship1[1] - 2, ship1[0] - 1];
                            cruiser = [ship1[1] - 3, ship1[0] - 1];
                    ...
                    else if (direction == 1) //down
                    {
                        if (ship1[1] < 7)
                        {
                            cruiser = grid[ship1[1] - 1, ship1[0] - 1];
                            grid[ship1[1], ship1[0] - 1] = "C";
                            grid[ship1[1] + 1, ship1[0] - 1] = "C";
                    ...
                    else if (direction == 2) //left
                    {
                        ...
                        {
                            grid[ship1[1] - 1, ship1[0] - 1] = "C";
                            grid[ship1[1] - 1, ship1[0] - 2] = "C";
                            grid[ship1[1] - 1, ship1[0] - 3] = "C";
                ...
                //maybe store cruiser in 2 dimnesional array
                //int[,] cruiser = new int[3,3];
                //Console.WriteLine(direction);
                ...
                while (game_on == true) //game will play again unless the user says no at the end of the game
                {
                    ...
                    /*
                     *if their pick is == M make them pick again 
                     *if their pick is == X make them pick again and dont add to counter
                     * 
                     * 
                     */
                    Console.Clear();
